...
== Authentication
  bit.ly API requires authentication credentials. You can get it on {bit.ly website}[app.bitly.com/Ba48fIHfOg5/bitlinks/2Q1GQcD?actions=accountMain&actions=settings&actions=advancedSettings&actions=apiSupport].
